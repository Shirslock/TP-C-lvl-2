...
namespace negocio
{
    public class ArticuloNegocio
    {
        ...
        public List<Articulo> filtrar(string campo, string criterio, string filtro)
        {
            ...
            try
            {
                string consulta = "select Codigo, Nombre, A.Descripcion, C.Descripcion Categoria, M.Descripcion Marca, ImagenUrl, Precio, A.IdCategoria , A.IdMarca , A.Id  from ARTICULOS A, CATEGORIAS C, MARCAS M where M.Id = A.IdMarca and C.Id = A.IdCategoria AND ";
                switch (campo)
                {
                    case "Precio":
                        switch (criterio)
